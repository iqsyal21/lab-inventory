...
<div class="offcanvas offcanvas-end" tabindex="-1" id="filterDrawer" aria-labelledby="filterDrawerLabel">
    ...
    <div class="offcanvas-body">
        <form method="GET" action="{{ route('loans.index') }}" id="filterForm">
            <div class="mb-3">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="d-flex justify-content-center gap-2">
                                ...
                                <form action="{{ route('loans.destroy', $loan->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus data peminjaman ini?')">
                                    @csrf
                                    @method('DELETE')
