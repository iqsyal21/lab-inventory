...
<form action="{{ route('items.update', $item->id) }}" method="POST" class="p-4 border rounded bg-light shadow-sm">
    @csrf
    @method('PUT')
    ...
    <div class="row mb-3">
        <div class="col-md-6">
            ...
            <input type="number" id="quantity_total" name="quantity_total" class="form-control"
                value="{{ old('quantity_total', $item->quantity_total) }}" min="0" required>
        </div>
        <div class="col-md-6">
            ...
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="condition" id="condition_baik" value="Baik"
                    {{ old('condition', $item->condition) == 'Baik' ? 'checked' : '' }}>
            ...
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="condition" id="condition_rusak" value="Rusak"
                    {{ old('condition', $item->condition) == 'Rusak' ? 'checked' : '' }}>
    ...
    <div class="mb-4">
        ...
        <input type="text" id="location" name="location" class="form-control"
            value="{{ old('location', $item->location) }}" placeholder="Contoh: Lemari 1 / Rak Atas">
    </div>
